...
const log = (str, ignore = false) => {
  // const args = Array.prototype.slice.call(arguments,0)
  // console.log.apply(null, ['ReactFiberWorkLoop - '].concat(args))
  if(!ignore)
  console.log('ReactFiberWorkLoop - ', str);
}
...
export function requestCurrentTimeForUpdate() {
  log('requestCurrentTimeForUpdate')
...
function performConcurrentWorkOnRoot(root, didTimeout) {
  log('performConcurrentWorkOnRoot')
  ...
  if (expirationTime !== NoWork) {
    ...
    if (workInProgress !== null) {
      ...
      if (root.callbackNode === originalCallbackNode) {
        log('root.callbackNode === originalCallbackNode')
...
function flushPendingDiscreteUpdates() {
  log('flushPendingDiscreteUpdates')
  if (rootsWithPendingDiscreteUpdates !== null) {
...
function workLoopConcurrent() {
  log('workLoopConcurrent')
  // Perform work until Scheduler asks us to yield
  let y = shouldYield()
  while (workInProgress !== null && !y) {
    workInProgress = performUnitOfWork(workInProgress);
    y = shouldYield()
  }
}
...
function performUnitOfWork(unitOfWork: Fiber): Fiber | null {
  log(typeof unitOfWork.elementType === 'function' ? unitOfWork.elementType.name : unitOfWork.elementType)
  log('performUnitOfWork')
