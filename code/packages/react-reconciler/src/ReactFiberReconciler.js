...
const log = str => {
  console.log('ReactFiberReconciler.js - ',str);
}
...
export function attemptSynchronousHydration(fiber: Fiber): void {
  console.log(`attemptSynchronousHydration`,)
  switch (fiber.tag) {
    case HostRoot:
...
export function attemptUserBlockingHydration(fiber: Fiber): void {
  console.log(`attemptUserBlockingHydration`,)
...
export function attemptContinuousHydration(fiber: Fiber): void {
  console.log(`attemptContinuousHydration`,)
  if (fiber.tag !== SuspenseComponent) {
    // We ignore HostRoots here because we can't increase
    // their priority and they should not suspend on I/O,
    // since you have to wrap anything that might suspend in
...
export function attemptHydrationAtCurrentPriority(fiber: Fiber): void {
  console.log(`attemptHydrationAtCurrentPriority`,)
  if (fiber.tag !== SuspenseComponent) {
    // We ignore HostRoots here because we can't increase
